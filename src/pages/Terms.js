  ...
  return (
    <div style={{width:'100%', backgroundImage: `url(${background})` }}>
      <main style={{ marginLeft: "5vw", marginRight: "5vw" }}>
        ...
        <h1>3. License</h1>
        <h2>3.1. Grant of a Limited License to Use the Services</h2>
        <p>
        ...
        <h2>3.2. Conditions of License</h2>
        <p>
        ...
        <h2>3.3. Login Information and Your Account</h2>
        <p>
        ...
        <h2>3.5. Suspension and Termination of Services</h2>
        <p>
        ...
        <h2>4.1. Applications and Services</h2>
        <p>
        ...
        <h2>5.2. Fees, Refunds and Return Policy</h2>
        <p>
