...
const Privacy = () => {
  return (
    <div style={{width:'100%', backgroundImage: `url(${background})` }}>
      <main style={{ marginLeft: "5vw", marginRight: "5vw" }} class="main">
        <h1>1. Purpose</h1>
        <p>
        ...
        <h2>3.1.2. Information Collected Directly from You</h2>
        <p>
        ...
        <h2>3.1.3. Automated Data Collection</h2>
        <p>
        ...
        <h2>3.1.4. Information Submitted Via Services</h2>
        <p>
        ...
        <h2>3.1.6. Social Media Widgets</h2>
        <p>
        ...
        <h2>3.2.1. Provide Services or Information Requeste</h2>
        <p>
        ...
        <h2>3.2.2. Inform You about Our Applications, Products and Services</h2>
        <p>
        ...
        <h2>3.2.3. Send Push Notifications</h2>
        <p>
        ...
        <h2>3.2.4. Use Anonymous and Aggregated Information</h2>
        <p>
        ...
        <h2>3.2.5. Provide Services via Mobile Devices</h2>
        <p>
        ...
        <h2>3.3.2. Opting Out of Cookie Tracking</h2>
        <p>
